...
<div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">Công cụ</h1>
            <div class="custom-breadcrumbs">
              <a href="index.php">Trang chủ</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong>Công cụ</strong></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="site-section services-section bg-light block__62849" id="next-section">
      <div class="container">
        <div class="row">
          <?php 
  $sql="SELECT * FROM CMS ORDER BY ID ASC";
$run=oci_parse($conn,$sql);
oci_execute($run);
$dem=1;
while($row=oci_fetch_array($run)){
  $id = $row[0];
          echo '<div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">';
            echo '<a href="service-single.php?idcc='.$id.'&hinh='.$dem.'" class="block__16443 text-center d-block">';
              echo '<span class="custom-icon mx-auto">';
                  if($dem==1)
                    echo '<span class="icon-magnet d-block"></span></span>';
                  if ($dem==2) 
                    echo '<span class="icon-trophy d-block"></span></span>';
                  if ($dem==4) 
                    echo '<span class="icon-laptop d-block"></span></span>';
                  if ($dem==3) 
                    echo '<span class="icon-search d-block"></span></span>';
                  if ($dem==5) 
                    echo '<span class="icon-paper-plane d-block"></span></span>';
                  if ($dem==6){ 
                    echo '<span class="icon-plug d-block"></span></span>';
                    $dem=0;
                  }
                $dem++;
                $stringCut=substr($row[5]->load(), 0,100);
                $string=substr($stringCut,0,strrpos($stringCut, ' '));
              echo '<h3>'.$row[4]->load().'</h3>';
              echo '<p>'.$string.'</p>';
              echo '</a></div>';
              } 
          oci_close($conn);
         ...
         <!--  <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <p>Chiến lược tiếp thị là bước căn bản nhằm đạt được mục tiêu là tăng doanh số tuyển dụng và có một lợi thế cạnh tranh bền vững.</p>
            </a>            
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <h3>Thiết kế web</h3>
              <p>Thiết kế web đòi hỏi các công ty thiết kế website phải thay đổi không ngừng.</p>
            </a>            
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <h3>SEO</h3>
              <p>Là một tập hợp các phương pháp nhằm nâng cao thứ hạng của một website trong các trang kết quả của các công cụ tìm kiếm (phổ biến nhất là Google).</p>
            </a>
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <h3>Tiếp thị hàng đầu </h3>
              <p>Trong những năm gần đây, các phương pháp tiếp cận 4Ps đã được coi là 1 giới hạn trong việc mô tả quá trình tiếp thị.</p>
            </a>
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="service-single.html" class="block__16443 text-center d-block">
              ...
              <h3>Thiết kế pixel hoàn hảo</h3>
              <p class="d-sm-block">Trong suốt quá trình làm việc của mình, tôi đã có cơ hội cộng tác với nhiều UI/UX designer.</p>
            </a>
