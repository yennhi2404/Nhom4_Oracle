...
<div class="site-wrap">
    ...
    <table align="center">
    <tr>
        <td colspan="2"><h2 style="text-align: center; font-family: Arial">Thêm câu hỏi đáp mới</h2></td>
    </tr> 
    <tr>
        <td>Câu hỏi: </td>
        <td><label>
            <textarea type="text" name="hoi" id="hoi" style="width: 300px"><?php if(isset($_POST["hoi"])) echo $_POST["hoi"]; else echo ''; ?></textarea>
        </label></td>
    </tr>
    <tr>
        <td>Trả lời: </td>
        <td><label>
            <textarea type="text" name="dap" id="dap" style="width: 300px"><?php if(isset($_POST["dap"])) echo $_POST["dap"]; else echo ''; ?></textarea>
        </label></td>
    </tr> 
    <tr>
        <td>Số lần hỏi: </td>
        <td><label>
            <input type="text" name="solan" id="solan" style="width: 300px" value="<?php if(isset($_POST["solan"])) echo $_POST["solan"]; else echo ''; ?>">
        </label></td>
    </tr>
    <br>
    <tr>
        <td colspan="2" align="center"><label>
            <input type="submit" name="Luu" value="Tạo">
        </label></td>
    </tr>
    <tr>
...
<?php
        if(isset($_POST["Luu"])) { //Khi nhấn Lưu sẽ thực hiện các câu lệnh     
            ...
            $result=oci_parse($conn,"INSERT INTO FAQS (FAQ_QUESTION,FAQ_ANSWER,SORT_ORDER,CREATED_AT) VALUES ('$hoi','$dap','$solan',sysdate)"); //Thêm dữ liệu tương ứng vào database 

            if($check<>0){ //Kiểm tra và xuất thông báo
                oci_execute($result);
                echo "<br><h3 align='center' style='color:red'>Thêm câu hỏi đáp mới thành công!</h3>";
            }else echo "<h3 align='center' style='color:red'>Thêm câu hỏi đáp mới thất bại! </h3>".oci_error($result);                
        } 
      }   
      oci_close($conn);
 ?>
