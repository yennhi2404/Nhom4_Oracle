...
<div class="site-wrap">
    ...
    <section class="site-section">
      <div class="container">
      <p align="center">
        <input type="button" value="Cập nhật thông tin" onclick="location.href='quanlyblog.php';">
      </p>
        <?php      
          include "dbconnect.php";
          $flag = false;
        ...
        if($flag==true){  
          $idblog = $_REQUEST["id"];
          $result = oci_parse($conn,"DELETE FROM CMS_CONTENT WHERE ID like '$idblog'");
          oci_execute($result);
          echo "<p align = 'center'>Đã xóa blog mã <b>$idblog</b></p>";          
          oci_close($conn);
        }
        ?>
</div>
