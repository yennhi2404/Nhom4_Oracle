      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5">
            <h2 class="mb-4">Đăng ký JobBoard</h2>
            <form  class="p-4 border rounded" name="form1" action="testintivated.php" method="post" onsubmit="return ValidateEmail(document.form1.txtEmail)">
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Họ Tên</label>
                  <input type="text" id="fname" name ="txtLaName" class="form-control" placeholder="Last Name" required>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Username</label>
                  <input type="text" id="fname" name ="txtFiName" class="form-control" placeholder="First Name" required>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Email</label>
                  <input type="text" id="email" name ="txtEmail" class="form-control" placeholder="Email address"  required>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Mật khẩu</label>
                  <input type="password" id="fname" name="txtMK" class="form-control" placeholder="Password" required>
                </div>
              </div>
              <div class="row form-group mb-4">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Nhập lại mật khẩu</label>
                  <input type="password" id="fname" name="txtreMK" class="form-control" placeholder="Re-type Password" required>
                </div>
              </div>
          ...
          <div class="col-lg-6">
            <h2 class="mb-4">Đăng nhập JobBoard</h2>
            <form action="xulydn.php" class="p-4 border rounded" method="post">

              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname" >Email</label>
                  <input type="text" id="fname" name="txtmail" class="form-control" placeholder="Email address">
                </div>
              </div>
              <div class="row form-group mb-4">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Mật khẩu</label>
                  <input type="password" id="fname" name="txtpass" class="form-control" placeholder="Password">
