...
<div class="site-wrap">
    ...
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('images/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <h1 class="text-white font-weight-bold">Danh mục đầu tư đơn (Trang bổ sung)</h1>
            <div class="custom-breadcrumbs">
              <a href="index.php">Trang chủ</a> <span class="mx-2 slash">/</span>
              <a href="portfolio.php">Danh mục đầu tư</a> <span class="mx-2 slash">/</span>
              <span class="text-white"><strong>Danh mục đầu tư đơn</strong></span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row mb-5 mt-5">
          ...
          <div class="col-lg-8">
            <?php 
              $maduan = $_GET["iddd"];
              $orc="SELECT ID, IMAGE,DESCRIPTION, URL,TO_CHAR(DATE_START,'DD-MM-YYYY HH24:MI:SS'),TO_CHAR(DATE_END,'DD-MM-YYYY HH24:MI:SS') FROM PROFILE_PROJECTS WHERE ID = $maduan";
              $run=oci_parse($conn,$orc);
              oci_execute($run);
              $i=0;
              while ($row=oci_fetch_array($run)){
                $gallery = explode('*',$row[1],4); 
                for($i=0;$i<3;$i++){
                  echo '<figure>
                        <a href="images/'.$gallery[$i].'" data-fancybox="gallery"><img src="images/'.$gallery[$i].'" alt="Free Website Template by Free-Template.co" class="img-fluid" width="600px" height="500px"></a>
                        </figure>';
                }
                echo '</div>';
            
            // <figure>
            //   <a href="images/" data-fancybox="gallery"><img src="images/sq_img_6.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
            // </figure>
            // <figure>
            ...
            // </figure>
            // <figure>
            //   <a href="images/sq_img_7.jpg" data-fancybox="gallery"><img src="images/sq_img_7.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
            // </figure>
            // <figure class="mb-0">
            //   <a href="images/sq_img_8.jpg" data-fancybox="gallery"><img src="images/sq_img_8.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid"></a>
            // </figure> 
          

         echo '<div class="col-lg-4 ml-auto h-100 jm-sticky-top">
            <div class="mb-4">
              <h3 class="mb-4 h4 border-bottom">Mô tả dự án</h3>
              <p class="mb-0">'.$row[2]->load().'</p>
            </div>
            ...
            <div class="row mb-4">
              ...
              <div class="col-sm-12 col-md-12 mb-4 col-lg-12">
                <strong class="d-block text-black">Ngày bắt đầu</strong>'
                .$row[4].'
              </div>
              <div class="col-sm-12 col-md-12 mb-4 col-lg-12">
                <strong class="d-block text-black">Ngày kết thúc</strong>'
                .$row[5].'
              </div>
              <div class="col-sm-12 col-md-12 mb-4 col-lg-12">
                <strong class="d-block text-black mb-3">Website URL</strong>
                <a href="'.$row[3].'" class="btn btn-outline-primary border-width-2">Ghé Website</a>
              </div>';
            ...
            <div class="block__87154 mb-0">
                ...
                <blockquote>
                  <p>Dự án của bạn sẽ rất dễ dừng lại hoặc cần xem xét lại nếu bạn chưa đánh giá hết mức độ quan trọng hoặc tính thụ hưởng của tất cả các thành phần liên quan trong dự án, ảnh hưởng tác động về quyền lợi của họ và của bộ phận họ như thế nào trong quá trình triển khai và vận hành dự án.</p>
                </blockquote>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 text-center">
            <?php $maduan = $_GET["iddd"]; 
              $lui = $maduan - 1;
              echo '<a href="portfolio-single.php?iddd='.$lui.'" class="btn btn-md btn-outline-primary border-width-2 d-block">Dự án trước</a>';
            ?>
          </div>
          <div class="col-md-4 text-center">
            <a href="portfolio.php" class="btn btn-md btn-primary border-width-2 d-block">Tất cả dự án</a>
          </div>
          <div class="col-md-4 text-center">
            <?php $maduan = $_GET["iddd"]; 
              $tiep = $maduan + 1;
              echo '<a href="portfolio-single.php?iddd='.$tiep.'" class="btn btn-md btn-outline-primary border-width-2 d-block">Dự án tiếp</a>';
            ?>
          </div>
        </div>
      </div>
